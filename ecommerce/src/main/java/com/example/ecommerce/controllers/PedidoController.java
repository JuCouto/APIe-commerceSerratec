...
public class PedidoController {
	...
	/*
	 * @PostMapping("/dto") public ResponseEntity<PedidoDTO>
	 * savePedidoDTO(@RequestBody PedidoDTO pedidoDTO) { PedidoDTO novoPedidoDTO =
	 * pedidoService.savePedidoDTO(pedidoDTO); return new
	 * ResponseEntity<>(novoPedidoDTO, HttpStatus.CREATED); }
	 */
